function [theta_double_dot_new, Mass_Matrix, C_vector, G_vector, JTFtip] = ForwardDynamics(Mi, Mlist, Glist, twist_list, theta, theta_dot, Ftip, tau, g)
    ...
    for i = 1:n
       ...
       [mass_vec, ~, ~, ~, ~, ~] = InverseDynamics(Mi, Mlist, Glist, twist_list, theta, theta_dot_temp, theta_double_dot_temp, Ftip_temp, g_temp);
